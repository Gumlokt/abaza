...
class CreateOriginWordTable extends Migration {
    /**
     * Run the migrations.
     *
     * @return void
     */
    public function up() {
        Schema::create('origin_word', function (Blueprint $table) {
            $table->increments('id');

            $table->unsignedInteger('origin_id');
            $table->unsignedInteger('word_id');
            // $table->primary(['origin_id', 'word_id']);
    ...
    public function down() {
        Schema::dropIfExists('origin_word');
    }
}
